        ...
        <div class="posRel">
            <div class="d-flex flex-column flex-shrink-0 bg-color sideboard">
                ...
                <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
                    ...
                    <li class="nav-item ">
                        <a href="{{ route('download_template_user')}}" class="nav-link templateUsers py-3 border-bottom border-top rounded-0" aria-current="page" data-bs-toggle="tooltip" data-bs-placement="right">
                            Скачать шаблон для импорта пользователей
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a href="{{ route('download_template_departments_and_parts')}}" class="nav-link templateGroup py-3 border-bottom border-top rounded-0" aria-current="page" data-bs-toggle="tooltip" data-bs-placement="right">
